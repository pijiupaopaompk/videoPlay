...
public class IjkUniversalMediaController extends FrameLayout {
...
//    private boolean mFullscreenEnabled = false;
    ...
    public IjkUniversalMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public IjkUniversalMediaController(Context context) {
        super(context);
        init(context);
    }
...
//                mScaleButton.setVisibility(VISIBLE);
                mScaleButton.setVisibility(GONE);  //隐藏缩放按钮
...
//            mTitleLayout.setVisibility(VISIBLE);
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(R.mipmap.uvv_player_player_btn);
...
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(R.mipmap.uvv_star_zoom_in);
        } else {
            mScaleButton.setImageResource(R.mipmap.uvv_player_scale_btn);
        }
    }
...
//        mBackButton.setVisibility(mIsFullScreen ? View.VISIBLE : View.INVISIBLE);
        mBackButton.setVisibility(mIsFullScreen ? View.GONE : View.GONE);
    }
