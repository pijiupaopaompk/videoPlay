...
public class IjkVideoView extends SurfaceView
        implements IjkUniversalMediaController.MediaPlayerControl,OrientationDetector.OrientationChangeListener{
    ...
    private IjkUniversalMediaController mMediaController;
    private IjkMediaPlayer.OnCompletionListener mOnCompletionListener;
    private IjkMediaPlayer.OnPreparedListener mOnPreparedListener;
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(IjkVideoView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            info.setClassName(IjkVideoView.class.getName());
        }
    }
...
//                mMediaPlayer.setA;
    ...
    public void setMediaController(IjkUniversalMediaController controller) {
    ...
    IjkMediaPlayer.OnVideoSizeChangedListener mSizeChangedListener =
            new IjkMediaPlayer.OnVideoSizeChangedListener() {
                @Override
                public void onVideoSizeChanged(IMediaPlayer mp, int i, int i1, int i2,
                                               int i3) {
    ...
    IjkMediaPlayer.OnPreparedListener mPreparedListener = new IjkMediaPlayer.OnPreparedListener() {
        @Override
    ...
    private IjkMediaPlayer.OnErrorListener mErrorListener =
...
//                    }
    ...
    private IjkMediaPlayer.OnBufferingUpdateListener mBufferingUpdateListener =
     ...
     */
    public void setOnPreparedListener(IjkMediaPlayer.OnPreparedListener l)
    {
     ...
     * @param l The callback that will be run
     */
    public void setOnCompletionListener(IjkMediaPlayer.OnCompletionListener l)
    {
     ...
     * @param l The callback that will be run
     */
    public void setOnErrorListener(IjkMediaPlayer.OnErrorListener l)
    {
        mOnErrorListener = l;
    }
     ...
     * @param l The callback that will be run
     */
    public void setOnInfoListener(IjkMediaPlayer.OnInfoListener l) {
        mOnInfoListener = l;
    }
    ...
    private void enableOrientationDetect() {
        if (mAutoRotation && mOrientationDetector == null) {
            ...
            mOrientationDetector.setOrientationChangeListener(IjkVideoView.this);
...
*/
    ...
    public interface VideoViewCallback {
        ...
        void onPause(final IjkMediaPlayer mediaPlayer);
        void onStart(final IjkMediaPlayer mediaPlayer);
        void onBufferingStart(final IjkMediaPlayer mediaPlayer);
        void onBufferingEnd(final IjkMediaPlayer mediaPlayer);
    }
